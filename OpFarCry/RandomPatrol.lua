...
if RouteList == nil then
  env.info("Route Scheduler is missing - cannot live without it! Random Patrols is not loaded!")
  trigger.action.outText("Route Scheduler is missing - cannot live without it! Random Patrols is not loaded!", 600, false)
  return
end
